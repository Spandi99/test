...
export const AVATAR_PRESETS: AvatarOption[] = [
  {
    ...
    description: "Ausdauernder Pfadfinder mit Neon-Visor und Power-Cape.",
    layers: {
      id: "trailblazer",
      label: "Trailblazer",
      background: "from-emerald-500 via-emerald-600 to-slate-950",
      skinTone: "#f5c7a9",
      hairColor: "#2b1b13",
      outfitColor: "#0ea5e9",
      accentColor: "#22c55e",
      aura: "from-emerald-300/60 via-emerald-400/20 to-transparent",
      hairStyle: "undercut",
      accessory: "visor",
      outfitAccent: "tech",
      faceMark: "scar",
  ...
  },
  {
    id: "focus-prodigy",
    label: "Der Fokus-Pro",
    description: "Analytischer Stratege mit Holo-Brille und Datendrohne.",
    layers: {
      id: "focus-prodigy",
      label: "Fokus-Pro",
      background: "from-sky-500 via-indigo-700 to-slate-950",
      skinTone: "#f1a790",
      hairColor: "#1f2937",
      outfitColor: "#2563eb",
      accentColor: "#38bdf8",
      aura: "from-sky-300/60 via-indigo-500/20 to-transparent",
      hairStyle: "waves",
      accessory: "glasses",
      outfitAccent: "tech",
      faceMark: "freckles",
  ...
  },
  {
    ...
    description: "Visionäre Künstlerin mit Farbwirbel und Lichtgeist.",
    layers: {
      id: "creative-spark",
      label: "Ideenfunke",
      background: "from-amber-300 via-rose-400 to-indigo-900",
      skinTone: "#f7d3b4",
      hairColor: "#b45309",
      outfitColor: "#f97316",
      accentColor: "#fb7185",
      aura: "from-amber-200/60 via-rose-400/20 to-transparent",
      hairStyle: "braids",
      accessory: "earrings",
      outfitAccent: "cloak",
      faceMark: "paint",
  ...
  },
  {
    id: "night-owl",
    label: "Der Night-Owl",
    description: "Mystischer Taktiker mit Schattenhaube und Sternenglut.",
    layers: {
      id: "night-owl",
      label: "Night Owl",
      ...
      outfitColor: "#4c1d95",
      accentColor: "#8b5cf6",
      aura: "from-purple-300/50 via-slate-900/30 to-transparent",
      hairStyle: "mohawk",
      accessory: "hood",
      outfitAccent: "armor",
      faceMark: "none",
